[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/PYot9Dit)
# Анализ данных о жилых домах

Ознакомьтесь с описанием задания и кратким руководством для разработчиков по настройке окружения и работе с проектом.
...
## Краткое руководство по настройке окружения и работе с проектом
...
> Подробнее об активации: [официальная документация `venv`](https://docs.python.org/3/library/venv.html#how-venvs-work)
...
Проект использует [`pre-commit`](https://pre-commit.com/) для автоматического форматирования и линтинга кода перед каждым коммитом.

Установите хуки в Git:
   ```bash
   pre-commit install
   ```

> В проекте настроены хуки для [Ruff](https://docs.astral.sh/ruff/) — быстрого линтера и форматера. Это гарантирует единообразие кода и своевременное выявление ошибок.

### 4. Запуск тестов

Тесты запускаются с помощью [`pytest`](https://docs.pytest.org/):
